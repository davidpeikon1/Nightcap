...
struct QuoteLibrary {
    ...
    static func dayContextFact(for day: Int) -> String? {
        ...
        case 46...52: return "Seven weeks. Slow-wave sleep is structurally different — nocturnal glucose is stable enough that the 3am cortisol spike isn't firing."
        case 53...59: return "Past seven weeks. The compound effects are still accumulating — they're just less visible than they were in the first two weeks."
        case 60:    return "Two months. Gut microbiome, dopamine, taste receptors — all measurably transformed."
        case 61...67: return "Past two months. CRP and other inflammatory biomarkers have had meaningful time to fall. The background noise is quieter."
        case 68...74: return "Ten weeks. Approaching 75 days — where dopamine receptor density reaches meaningful recovery from chronic suppression."
